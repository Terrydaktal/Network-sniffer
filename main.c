 ...
 */
#define OPTSTRING "vi:" //the different options
static struct option long_opts[] = {			/*declare long_opts as a static array of option structs*/ 
...
/* Print usage if no command line options are specified
 */
